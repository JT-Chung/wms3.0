export default {
  ...
  'user.login.username.placeholder': '账号: 请输入账号',
  'user.login.password.placeholder': '密码: 请输入密码',
  'user.login.message-invalid-credentials': '账户或密码错误（admin/wms control system）',
