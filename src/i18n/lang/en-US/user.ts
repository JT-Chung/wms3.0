export default {
  ...
  'user.login.username.placeholder': 'Account: Please input Username',
  'user.login.password.placeholder': 'password: Please input password',
  'user.login.message-invalid-credentials': 'Invalid username or password（admin/wms control system）',
